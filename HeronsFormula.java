public class HeronsFormula {
  ...
  //1. The one without a function is longer.
  //2. Not that much harder, but using functions makes it easier.
  //3. Not difficult. It would have been about 5 or so extra lines of code.
}
